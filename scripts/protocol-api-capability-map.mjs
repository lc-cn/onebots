...
const oneBotV11 = [
    ...
    ["get_friend_msg_history", { action: "get_message_history", scene: "private" }],
    ["get_group_msg_history", { action: "get_message_history", scene: "group" }],
    ["send_private_forward_msg", { allOf: ["make_forward_message", "send_message"] }],
    ["send_group_forward_msg", { allOf: ["make_forward_message", "send_message"] }],
    "send_like",
