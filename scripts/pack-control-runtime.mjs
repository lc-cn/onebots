...
/** Build-time only: pack the two built gateway hosts, never the workspace root or runtime data. */
    ...
    try {
        ...
        for (const [key, folder, expectedName] of [
            ...
            if (
                ...
                throw new Error("运行宿主的包名或版本无效");
            await access(path.join(directory, "lib/index.js"));
            if (key === "host") await access(path.join(directory, "lib/gateway/entry.js"));
