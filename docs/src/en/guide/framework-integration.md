...
| NoneBot2 | General framework | OneBot 11 reverse WebSocket | OneBot 11 forward WebSocket, OneBot 12 | Supported upstream; pinned end-to-end verification pending |
...
1. **NoneBot2 + OneBot 11** establishes the profile, configuration renderer, and interop harness against a mature and clearly documented adapter.
