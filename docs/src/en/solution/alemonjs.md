...
AlemonJS is available through the OneBots Application runtime. Activate it with `-t alemonjs`; the Application is applied to every protocol instance and publishes its connections, actions, routes, and limitations.
...
| Protocol | `onebot.v11` |
| Transport | `websocket` |
| Pinned gate | `2.1.103 / adapter 2.1.21` |
