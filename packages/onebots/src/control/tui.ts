...
import { runControlVerification, queryControlVerification } from "./tui-verification.js";
        ...
        try {
            [action] = await prompt.ask({
                ...
                choices: [
                    ...
                    { value: "verification", label: "账号登录验证" },
                    { value: "verification-operation", label: "查询验证回执" },
