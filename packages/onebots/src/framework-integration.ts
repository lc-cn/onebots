...
const PROFILES: Readonly<Record<FrameworkId, FrameworkProfile>> = deepFreeze({
    ...
    karin: {
        ...
        defaultFrameworkOrigin: null,
        limitations: ["尚未在 OneBots CI 中固定 Karin 与 Milky 适配器版本。"],
    },
    zhin: {
        id: "zhin",
        displayName: "Zhin",
        ...
        defaultFrameworkOrigin: null,
        limitations: ["尚未在 OneBots CI 中固定 Zhin 与 OneBot 11 适配器版本。"],
    },
    alemonjs: {
        id: "alemonjs",
        ...
        defaultFrameworkOrigin: null,
        limitations: ["OneBot 12 仍是上游实验路径；默认模板固定使用 OneBot 11。"],
    },
    yunzai: {
        id: "yunzai",
