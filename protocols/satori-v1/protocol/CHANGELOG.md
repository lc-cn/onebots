...
- 75e472c: 重构 Satori 动作边界，移除非标准动作别名，使用真实 Guild/Channel 目录能力，并闭合 Webhook 与 READY 身份生命周期。
...
- 708f473: 以显式频道路由替代 Satori 消息场景的 ID 字符串猜测，并为无群组对象的私聊事件补齐标准 channel 投影。
