import type { DirectoryQueryOptions, Friend, Group, User } from "imhelper";
...
export class MilkyDirectoryApi {
    ...
    async getUserInfo(userId: string, options?: DirectoryQueryOptions): Promise<User<string>> {
    ...
    async getFriendInfo(userId: string, options?: DirectoryQueryOptions): Promise<Friend<string>> {
    ...
    async getUserList(options?: DirectoryQueryOptions): Promise<User<string>[]> {
    ...
    async getGroupInfo(groupId: string, options?: DirectoryQueryOptions): Promise<Group<string>> {
    ...
    async getGroupList(options?: DirectoryQueryOptions): Promise<Group<string>[]> {
    ...
    async getGroupMemberList(
        ...
        const members = Array.isArray(response.data)
            ...
            : isRecord(response.data) && Array.isArray(response.data.members)
              ...
              : [];
        return members.filter(isRecord).map(
            member =>
                ({
                    info: {
