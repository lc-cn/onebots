...
export class GuildAction {
    ...
    async muteGuildMembers(this:V12,guild_id:string,member_ids:string[],seconds:number,end_time?:number){
        return this.adapter.call(this.oneBot.uin, 'V12', 'muteGuildMembers', [guild_id, member_ids, seconds, end_time])
    }
    async addGuildMemberRoles(this:V12,guild_id:string,channel_id:string,member_id:string,role_id:string){
        return this.adapter.call(this.oneBot.uin, 'V12', 'addGuildMemberRoles', [guild_id, channel_id, member_id, role_id])
    }
    async removeGuildMemberRoles(this:V12,guild_id:string,channel_id:string,member_id:string,role_id:string){
        return this.adapter.call(this.oneBot.uin, 'V12', 'removeGuildMemberRoles', [guild_id, channel_id, member_id, role_id])
    }
    async kickGuildMember(this:V12,guild_id:string,member_id:string,clean:-1|0|3|7|15|30=0,blacklist?: boolean){
    ...
    async muteGuildMember(this:V12,guild_id:string,member_id:string,seconds:number,end_time?:number){
