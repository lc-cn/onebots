...
export class OneBotV12Protocol extends Protocol<"v12", Account.Config<'onebot',"v12">> {
     ...
     */
    private convertToV12Segments(segments: CommonEvent.Segment[]): OneBotV12.Segment[] {
     ...
     */
    private convertToCommonSegments(segments: OneBotV12.Segment[]): CommonEvent.Segment[] {
        return segments.map(seg => {
