...
export const icqqCapabilities: AdapterCapabilityManifest = defineAdapterCapabilities({
    ...
    segments: {
        ...
        flash: { support: "native", direction: "both" },
        record: { support: "native", direction: "both" },
        audio: { support: "native", direction: "send" },
        video: { support: "native", direction: "both" },
        bubble: { support: "native", direction: "both" },
        reply: { support: "native", direction: "both" },
        share: { support: "native", direction: "both" },
        location: { support: "native", direction: "both" },
        poke: { support: "native", direction: "both" },
        rps: { support: "native", direction: "both" },
        dice: { support: "native", direction: "both" },
        bface: { support: "native", direction: "both" },
        markdown: { support: "native", direction: "both" },
        button: { support: "native", direction: "both" },
        mirai: { support: "native", direction: "both" },
        long_msg: { support: "native", direction: "both" },
        forward: { support: "native", direction: "both" },
        node: { support: "native", direction: "both" },
        quote: { support: "native", direction: "both" },
        file: { support: "native", direction: "both" },
        forum: { support: "native", direction: "receive" },
