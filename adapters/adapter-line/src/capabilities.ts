...
export const lineCapabilities: AdapterCapabilityManifest = defineAdapterCapabilities({
    actions: {
        ...
        get_profile: { support: "native" },
        get_followers: { support: "native" },
        get_group_summary: { support: "native" },
        get_group_member_count: { support: "native" },
        get_group_member_profile: { support: "native" },
        get_group_member_ids: { support: "native", availability: "permission" },
        leave_room: { support: "native" },
