...
export const WECHAT_AUDIENCE_ACTIONS = defineWechatActionContract(
    {
        ...
        update_tag: async (client: WechatClient, params: WechatActionParams) =>
            post(client, "/cgi-bin/tags/update", {
                tag: { id: requireInteger(params, "tag_id"), name: requireString(params, "name") },
            }),
        delete_tag: async (client: WechatClient, params: WechatActionParams) =>
            post(client, "/cgi-bin/tags/delete", {
                tag: { id: requireInteger(params, "tag_id") },
            }),
    ...
    } satisfies Readonly<Record<string, WechatActionHandler>>,
    {
        ...
        get_wechat_user_info: ["openid", "lang"],
        batch_get_user_info: ["openids"],
        set_user_remark: ["openid", "remark"],
        get_tags: [],
        create_tag: ["name"],
        update_tag: ["tag_id", "name"],
        delete_tag: ["tag_id"],
        tag_users: ["openids", "tag_id"],
        untag_users: ["openids", "tag_id"],
        get_user_tags: ["openid"],
        get_tag_users: ["tag_id", "next_openid"],
        get_blacklist: ["begin_openid"],
        block_users: ["openids"],
        unblock_users: ["openids"],
    },
);
