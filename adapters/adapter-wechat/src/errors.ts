...
export class WechatApiError extends OneBotsError {
    readonly status?: number;
    readonly path?: string;
    readonly details?: unknown;

    constructor(message: string, options: WechatApiErrorOptions = {}) {
        super(message, {
            code: options.code || "WECHAT_API_ERROR",
...
function categoryFor(options: WechatApiErrorOptions): ErrorCategory {
