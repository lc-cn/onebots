...
/** 公众号多客服账号与会话管理。 */
export const WECHAT_CUSTOMER_SERVICE_ACTIONS = {
    add_customer_service_account: postRecordAction("/customservice/kfaccount/add", "account"),
    update_customer_service_account: postRecordAction("/customservice/kfaccount/update", "account"),
    ...
    create_customer_service_session: postRecordAction("/customservice/kfsession/create", "session"),
    close_customer_service_session: postRecordAction("/customservice/kfsession/close", "session"),
