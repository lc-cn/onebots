...
export const kookCapabilities: AdapterCapabilityManifest = defineAdapterCapabilities({
    ...
    events: {
        ...
        guild_role_created: { support: "native" },
        guild_role_updated: { support: "native" },
        guild_role_deleted: { support: "native" },
        emoji_created: { support: "native" },
        emoji_updated: { support: "native" },
        emoji_deleted: { support: "native" },
