...
export const kookCapabilities: AdapterCapabilityManifest = defineAdapterCapabilities({
    actions: {
        ...
        get_group_list: { support: "emulated", note: "将 KOOK 服务器投影为群组" },
        get_group_info: { support: "emulated", note: "将 KOOK 服务器投影为群组" },
        ...
        set_group_card: { support: "native", availability: "permission" },
